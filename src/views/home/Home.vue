...
export default {
  ...
  methods: {
    draw () {
      ...
      // 搜索线形图
      const lineChart = echarts.init(document.getElementById('search'))
      lineChart.setOption(this.opt())
      //        搜索线形图
      const lineChart1 = echarts.init(document.getElementById('search1'))
      ...
      // tab柱状图(销售)
      const bar = echarts.init(document.getElementById('sale'))
      bar.setOption(this.option())
      // tab柱状图(访问量)
      const bar_scan = echarts.init(document.getElementById('scan'))
