    ...
    <div class="page-header-index-wide">
        <a-row :gutter="24">
            <a-col :sm="24" :md="12" :xl="6" :style="{ marginBottom: '24px' }">
                <chart-card :loading="loading" title="Surface3总价值" total="￥12500">
                    <a-tooltip title="指标说明" slot="action">
                        <a-icon type="info-circle-o"/>
                    </a-tooltip>
                    <div>
                        <trend flag="up" style="margin-right: 16px;">
                            <span slot="term">设备</span>
                            10/台
                        </trend>
                        <trend flag="down">
                            <span slot="term">键盘</span>
                            4/个
                        </trend>
                    </div>
                    <template slot="footer">月均售出<span>5 台</span></template>
                </chart-card>
            </a-col>
            <a-col :sm="24" :md="12" :xl="6" :style="{ marginBottom: '24px' }">
        ...
        <a-card :loading="loading" :bordered="false" :body-style="{padding: '0'}">
            <div class="salesCard">
                <a-tabs default-active-key="1" size="large" :tab-bar-style="{marginBottom: '24px', paddingLeft: '16px'}">
                    ...
                    <a-tab-pane loading="true" tab="设备统计" key="1">
                        <a-row>
                    ...
                    <a-tab-pane tab="配件统计" key="2">
                        <a-row>
                            <a-col :xl="16" :lg="12" :md="12" :sm="24" :xs="24">
                                <bar title="数量/个"/>
                            </a-col>
                            <a-col :xl="8" :lg="12" :md="12" :sm="24" :xs="24">
                                <rank-list title="配件统计" :list="rankList"/>
                            </a-col>
                        </a-row>
                    </a-tab-pane>
                </a-tabs>
            ...
            <a-row :gutter="24">
                ...
                <a-col :xl="12" :lg="24" :md="24" :sm="24" :xs="24">
                    <a-card class="antd-pro-pages-dashboard-analysis-salesCard" :loading="loading" :bordered="false"
                            title="销售额类别占比" :style="{ marginTop: '24px', minHeight: '500px' }">
