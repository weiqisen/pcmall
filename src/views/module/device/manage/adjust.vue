  ...
  <page-view :title="title">
    <a-card :bordered="false">
        ...
        <a-form layout="inline">
          <a-row :gutter="48" style="margin: 0;">
            ...
            <a-col :md="24" :sm="24" style="padding: 0 3px;margin-top:10px;">
              <a-alert style="margin-bottom: 0 !important;"
      ...
      <div style="position: relative;min-height: 300px;margin: 10px 3px;">
        ...
        <span v-if="deviceList" v-for="(item, index) in deviceList" :key="index" :value="item.deviceId" @click="handleClickChange(item)" :style="{'cursor': 'pointer','top':item.distribuImgY+ 'px','left':item.distribuImgX+ 'px','position':position,'text-align': 'center'}">
